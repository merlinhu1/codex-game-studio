...
description: Use for Codex Game Studio create epics work: Break project goals into epics with outcomes, dependencies, risks, and validation gates.
model: gpt-5.5
...
Use this skill when the repository needs create-epics work with Codex-native model routing, bounded context, and reviewable evidence.
...
This skill is adapted from .claude/skills/create-epics/SKILL.md when available and translated into Codex-native model, tool-policy, sandbox, and handoff language. Claude-specific model/tool metadata is not used as runtime policy.
