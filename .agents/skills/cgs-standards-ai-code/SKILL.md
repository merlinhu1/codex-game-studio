...
Use this skill when the repository needs ai-code standard review with Codex-native model routing, bounded context, and reviewable evidence.
...
This skill adapts the CCGS `.claude/rules/ai-code.md` intent into a Codex-native standards skill. Claude-specific rule-file routing is not used as runtime policy.
