...
- Context bootstrap: `npm run ctx:workflow -- design-review-concept`, `npm run ctx:role -- senior-game-designer`, and `npm run ctx:changed` before broad reads when available.
