...
- Context bootstrap: `npm run ctx:workflow -- consistency-check`, `npm run ctx:role -- studio-orchestrator`, and `npm run ctx:changed` before broad reads when available.
