...
- Context bootstrap: `npm run ctx:workflow -- accessibility-doc`, `npm run ctx:role -- accessibility-specialist`, and `npm run ctx:changed` before broad reads when available.
