...
- Context bootstrap: `npm run ctx:workflow -- prototype`, `npm run ctx:role -- producer`, and `npm run ctx:changed` before broad reads when available.
