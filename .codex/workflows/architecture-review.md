...
- Context bootstrap: `npm run ctx:workflow -- architecture-review`, `npm run ctx:role -- technical-director`, and `npm run ctx:changed` before broad reads when available.
