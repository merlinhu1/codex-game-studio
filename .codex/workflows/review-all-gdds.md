...
- Context bootstrap: `npm run ctx:workflow -- review-all-gdds`, `npm run ctx:role -- senior-game-designer`, and `npm run ctx:changed` before broad reads when available.
