...
- [Approval Stores](../codex/approval-stores.md)

Truthmark installs [Repository Bootstrap Routing](bootstrap-routing.md) as a generated handoff for fresh repositories whose default broad route still needs to be split. In this repository, the bounded areas in `../../routes/areas/repository.md` remain canonical; do not expand the bootstrap handoff into behavior truth.
