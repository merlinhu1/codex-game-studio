...
Game concept scaffold for pitch, core fantasy, pillars, audience, constraints, and risks.

Use this Codex-native template when a game-studio task needs a reviewable `game-concept` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `game-concept` with assumptions labeled.
