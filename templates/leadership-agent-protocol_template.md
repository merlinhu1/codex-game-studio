...
Leadership-agent protocol scaffold for decisions, escalation, owner handoffs, and production gates.

Use this Codex-native template when a game-studio task needs a reviewable `leadership-agent-protocol` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `leadership-agent-protocol` with assumptions labeled.
