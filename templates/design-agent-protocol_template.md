...
Design-agent protocol scaffold for design responsibilities, required inputs, output contracts, and gates.

Use this Codex-native template when a game-studio task needs a reviewable `design-agent-protocol` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `design-agent-protocol` with assumptions labeled.
