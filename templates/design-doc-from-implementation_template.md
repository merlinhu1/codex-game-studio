...
Reverse-documented design scaffold for implemented systems, rules, edge cases, and evidence paths.

Use this Codex-native template when a game-studio task needs a reviewable `design-doc-from-implementation` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `design-doc-from-implementation` with assumptions labeled.
