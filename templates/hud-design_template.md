...
HUD design scaffold for information architecture, zones, element states, accessibility, and validation.

Use this Codex-native template when a game-studio task needs a reviewable `hud-design` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `hud-design` with assumptions labeled.
