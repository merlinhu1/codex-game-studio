...
Character sheet scaffold for role, motivation, voice, arc, relationships, and implementation hooks.

Use this Codex-native template when a game-studio task needs a reviewable `narrative-character-sheet` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `narrative-character-sheet` with assumptions labeled.
