...
Developer changelog scaffold for features, fixes, balance changes, known issues, and technical notes.

Use this Codex-native template when a game-studio task needs a reviewable `changelog-template` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `changelog-template` with assumptions labeled.
