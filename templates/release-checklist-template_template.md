...
Release checklist scaffold for build verification, quality gates, platform readiness, blockers, and ship verdict.

Use this Codex-native template when a game-studio task needs a reviewable `release-checklist-template` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `release-checklist-template` with assumptions labeled.
