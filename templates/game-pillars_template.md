...
Game pillars scaffold for core fantasy, pillars, non-goals, examples, and validation checks.

Use this Codex-native template when a game-studio task needs a reviewable `game-pillars` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `game-pillars` with assumptions labeled.
