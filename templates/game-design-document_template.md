...
Game design document scaffold for mechanics, systems, content, UX, progression, and acceptance criteria.

Use this Codex-native template when a game-studio task needs a reviewable `game-design-document` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `game-design-document` with assumptions labeled.
