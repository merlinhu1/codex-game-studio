...
Interaction pattern library scaffold for reusable UI controls, states, navigation, and accessibility rules.

Use this Codex-native template when a game-studio task needs a reviewable `interaction-pattern-library` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `interaction-pattern-library` with assumptions labeled.
