...
Incident response scaffold for severity, timeline, root cause, mitigation, rollback, and follow-up owners.

Use this Codex-native template when a game-studio task needs a reviewable `incident-response` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `incident-response` with assumptions labeled.
