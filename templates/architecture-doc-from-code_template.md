...
Reverse-documentation scaffold for observed code architecture, decisions, alternatives, consequences, and evidence.

Use this Codex-native template when a game-studio task needs a reviewable `architecture-doc-from-code` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `architecture-doc-from-code` with assumptions labeled.
