...
Faction design scaffold for identity, values, history, relationships, gameplay role, and content hooks.

Use this Codex-native template when a game-studio task needs a reviewable `faction-design` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `faction-design` with assumptions labeled.
