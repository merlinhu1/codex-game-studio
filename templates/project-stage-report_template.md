...
Project stage report scaffold for current phase, completeness, blockers, evidence, and recommended next steps.

Use this Codex-native template when a game-studio task needs a reviewable `project-stage-report` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `project-stage-report` with assumptions labeled.
