...
Prototype report scaffold for hypothesis, scope, results, metrics, recommendation, and follow-up risks.

Use this Codex-native template when a game-studio task needs a reviewable `prototype-report` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `prototype-report` with assumptions labeled.
