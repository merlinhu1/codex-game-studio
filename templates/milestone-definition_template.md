...
Milestone definition scaffold for goals, success criteria, feature tiers, cut lines, owners, and validation gates.

Use this Codex-native template when a game-studio task needs a reviewable `milestone-definition` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `milestone-definition` with assumptions labeled.
