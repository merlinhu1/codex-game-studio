...
Post-mortem scaffold for outcomes, what worked, what failed, root causes, actions, and owners.

Use this Codex-native template when a game-studio task needs a reviewable `post-mortem` artifact. Keep claims tied to source files, playtest observations, engine output, or explicit user decisions.
...
- Artifact body: structured sections appropriate for `post-mortem` with assumptions labeled.
